...
import "./MyToken7D2F461D.sol";

contract MyToken7D2F461DPreSale {
    MyToken7D2F461D public token;
    ...
    function MyToken7D2F461DPreSale(
        MyToken7D2F461D _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken7D2F461D(_token);
